...
(function() {
    ...
    db.clients = [
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/1.jpg",
            "Name": "Headphones",
            "Price": "$20.00",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/2.jpg",
            "Name": "Honor Mobile",
            "Price": "$462.00",
            "Status": "<i class=\"fa fa-circle font-success f-12\"></i>",
            "Category": "Electronics",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/3.jpg",
            "Name": "Samsung LED TV",
            "Price": "$652.00",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/4.jpg",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/5.jpg",
            "Name": "Apple 6s",
            "Price": "$782.00",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/6.jpg",
            "Name": "Printer",
            "Price": "$4825.00",
            "Status": "<i class=\"fa fa-circle font-warning f-12\"></i>",
            "Category": "Electronics",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/7.jpg",
            "Name": "Canon Camera",
            "Price": "$2461.00",
            "Status": "<i class=\"fa fa-circle font-success f-12\"></i>",
            "Category": "Electronics",
        },{
            "Image": "{% static '' %}images/dashboard-bases/catalog/8.jpg",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/9.jpg",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/10.jpg",
            "Name": "Diamond Ring",
            "Price": "$237.00",
            "Status": "<i class=\"fa fa-circle font-warning f-12\"></i>",
            "Category": "Jewellery",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/11.jpg",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/12.jpg",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/13.jpg",
            "Name": "Night lamp",
            "Price": "$84.00",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/14.jpg",
            "Name": "men's shoes",
            "Price": "$67.00",
            "Status": "<i class=\"fa fa-circle font-warning f-12\"></i>",
            "Category": "shoes",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/15.jpg",
            "Name": "Ledi's red top",
            "Price": "$234.00",
            "Status": "<i class=\"fa fa-circle font-success f-12\"></i>",
            "Category": "clothes",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/16.jpg",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/17.jpg",
            "Name": "Woman one pis",
            "Price": "$682.00",
            "Status": "<i class=\"fa fa-circle font-danger f-12\"></i>",
            "Category": "clothes",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/18.jpg",
            "Name": "Mouse",
            "Price": "$24.00",
            "Status": "<i class=\"fa fa-circle font-success f-12\"></i>",
            "Category": "electronics",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/19.jpg",
            "Name": "Coffee maker",
            "Price": "$9721.00",
            "Status": "<i class=\"fa fa-circle font-danger f-12\"></i>",
            "Category": "electronics",
        ...
        {
            "Image": "{% static '' %}images/dashboard-bases/catalog/20.jpg",
            "Name": "Diamond Nacklace",
            "Price": "$3579.00",
            "Status": "<i class=\"fa fa-circle font-warning f-12\"></i>",
            "Category": "Jewellery",
