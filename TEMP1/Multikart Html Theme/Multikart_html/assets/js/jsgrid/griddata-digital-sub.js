...
(function() {
    ...
    db.clients = [
        {
            "Image": "{% static '' %}images/digital-catalog/logo.jpg",
            "Name": "Logo Design",
            "Price": "$74.00",
        ...
        {
            "Image": "{% static '' %}images/digital-catalog/php.png",
            "Name": "Php",
            "Price": "$213.00",
        ...
        {
            "Image": "{% static '' %}images/digital-catalog/html.png",
            "Name": "Html",
            "Price": "$245.00",
        ...
        {
            "Image": "{% static '' %}images/digital-catalog/css.jpg",
            "Name": "Css",
            "Price": "$794.00",
            "Status": "<i class=\"fa fa-circle font-success f-12\"></i>",
            "Sub Category": "Digital",
        ...
        {
            "Image": "{% static '' %}images/digital-catalog/web-element.jpg",
            "Name": "Web element",
            "Price": "$5764.00",
            "Status": "<i class=\"fa fa-circle font-danger f-12\"></i>",
            "Sub Category": "Digital",
        ...
        {
            "Image": "{% static '' %}images/digital-catalog/wordpress.jpg",
            "Name": "Wordpress",
            "Price": "$347.00",
            "Status": "<i class=\"fa fa-circle font-danger f-12\"></i>",
            "Sub Category": "Digital",
        ...
        {
            "Image": "{% static '' %}images/digital-catalog/3d-design.jpg",
            "Name": "3D Design",
            "Price": "$5764.00",
            "Status": "<i class=\"fa fa-circle font-success f-12\"></i>",
            "Sub Category": "Digital",
