...
(function() {
    ...
    db.clients = [
        {
            "Image": "{% static '' %}images/digital-product/graphic-design.png",
            "Name": "Graphic Design",
            "Price": "$57.00",
        ...
        {
            "Image": "{% static '' %}images/digital-product/ebooks.png",
            "Name": "eBooks",
            "Price": "$472.00",
        ...
        {
            "Image": "{% static '' %}images/digital-product/lecture-video-recorder.jpg",
        ...
        {
            "Image": "{% static '' %}images/digital-product/application.jpg",
            "Name": "Application",
            "Price": "$578.00",
        ...
        {
            "Image": "{% static '' %}images/digital-product/web-dev.jpg",
            "Name": "Websites",
            "Price": "$5764.00",
            "Status": "<i class=\"fa fa-circle font-warning f-12\"></i>",
            "Category": "Digital",
