    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_type', models.CharField(choices=[('Home', 'Home'), ('Business', 'Business')], max_length=10)),
                ...
                ('area', models.ForeignKey(blank=True, max_length=50, null=True, on_delete=django.db.models.deletion.CASCADE, to='localization.area')),
                ('city', models.ForeignKey(max_length=20, on_delete=django.db.models.deletion.CASCADE, to='localization.city')),
                ('governorate', models.ForeignKey(max_length=150, on_delete=django.db.models.deletion.CASCADE, to='localization.governorates')),
